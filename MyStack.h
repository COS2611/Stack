...
bool isInLanguageL(std::string w)
{
	...
	// min word length: 2, shortest word: "ab"
	if (w.length() < 2)
	{
		return false;
	}
...
bool isInLanguageL2(std::string w)
{
	...
	// min word length: 3, shortest word: "abb"
	if (w.length() < 3)
	{
		return false;
	}
...
bool isInLanguageL3(std::string w)
{
	...
	// min word length: 1, shortest word: "a"
	if (w.length() < 1)
	{
		return false;
	}
